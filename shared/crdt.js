...
exports.MindMapCRDT = MindMapCRDT;
function mergeBranches(baseNodes, sourceOps, targetOps) {
...
function getDeletedNodes(baseNodes, finalNodes, ops) {
...
function cleanupOrphanNodes(nodes) {
    const result = {};
...
function findLastOpForNode(ops) {
    if (ops.length === 0)
        return null;
...
function resolveConflict(currentNodes, conflict, resolution) {
